  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/bookings/upload-receipt', {
        ...
        body:    JSON.stringify({ bookingNumber: bookingRef.trim().toUpperCase(), transactionRef, transferDate, amountPaid: Number(amountPaid), receiptUrl, notes }),
      });
      ...
      <div className="container mx-auto max-w-xl">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-sm text-blue-800">
            <strong>Instructions:</strong> Fill in your bank transfer details below. If you have a receipt
            image, you can share it via Google Drive / Dropbox and paste the link in the optional field.
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Receipt Image Link <span className="text-gray-400 font-normal">(optional)</span>
              </label>
              <input
                type="url"
                value={receiptUrl}
              ...
              <p className="text-xs text-gray-400 mt-1">
                Upload your receipt to Google Drive or Dropbox and paste the shareable link here.
              </p>
            </div>
